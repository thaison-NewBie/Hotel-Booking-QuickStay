...
const Hero = () => {
    ...
    const onSearch = async (e)=>{
        ...
        try {
            ...
            console.log('Could not save search history:', error.message)
        }

        // Add destinations to searchCities
        if (setSearchCities) {
    ...
    return (
        ...
        bg-no-repeat bg-cover bg-center h-screen'>
            ...
            <p>Unparalleled luxury and comfort await at the world's most exclusive hotels 
